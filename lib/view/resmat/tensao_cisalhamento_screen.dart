...
class TensaoCisalhamentoScreen extends StatefulWidget {
  const TensaoCisalhamentoScreen({super.key});

  @override
  State<TensaoCisalhamentoScreen> createState() => _TensaoCisalhamentoScreenState();
}

class _TensaoCisalhamentoScreenState extends State<TensaoCisalhamentoScreen> {
  final TextEditingController _forcaController =
    ...
    return Padding(
        ...
        child: Column(
          children: [
            ...
            getDefaultInputField(
                _tensaoController, 'Tensão cisalhamento(τ)', false,
                Constants.pressao,
                _pressaoDV,
                    (value) => {
                  setState(() {
            ...
            Padding(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () => {
                _tensaoController.text = TensaoCisalhamento(
